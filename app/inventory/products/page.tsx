                    ...
                    {data.map((data:any) =>(
                        editingRow === data.id ? (
                            <tr key={data.id}>
                                ...
                                <td></td>
                                <td><button onClick={handleEditCancel(data.id)}>キャンセル</button><button onClick={handleEditCancel(data.id)}>更新する</button><button onClick={handleDelete(data.id)}>削除する</button></td>
                            </tr>
                        ) : (
                        <tr key={data.id}>
                            <td>{data.id}</td>
                            ...
                            <td><button onClick={handleEditRow(data.id)}>更新・削除</button>
                                <button>更新・削除</button>
                            </td>
                        </tr>
                    )))}
